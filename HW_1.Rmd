...
library(tidyverse)
library(ggplot2)
folder_path <- "/Users/ivanzamorano/Downloads/Datasets" # use your own path here
...
person_type2 <- table(people_filtered3$PERSON_TYPE)
# Convert the frequency table into proportions

person_type_proportions <- prop.table(person_type2)

# Extract the proportion of pedestrians

passangers_proportion <- person_type_proportions["PASSENGER"]

passangers_proportion
```
